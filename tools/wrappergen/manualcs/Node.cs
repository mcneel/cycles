...
namespace ccl
{
    ...
    public class Node
    {
        ...
        /// </summary>
        public NodeOutputs outputs { get; set; }

        internal Node(string name)
        {
            ConstructNode(NodeTypeName, name);
        }

        internal Node(IntPtr nodePtr)
        {
            Ptr = nodePtr;
        }

        internal void ConstructNode(string NodeTypeName, string shaderNodeName)
        {
        }

        internal virtual void SetBool(string name, bool data) {}
        internal virtual void SetBooleanArray(string name, List<bool> data) {}
        internal virtual void SetClosure(string name, IntPtr data) {}
        ...
        internal virtual IntPtr GetClosure(string name) { return IntPtr.Zero; }
