...
{
	/// <summary>
	/// FloatArraySocket is used to communicate vectors between nodes.
	/// </summary>
	public class FloatArrayNodeSocket : NodeSocketBase<List<float>>
	{
		/// <summary>
		...
		public FloatArrayNodeSocket(Node parentNode, string name, string internalname, bool isInput)
