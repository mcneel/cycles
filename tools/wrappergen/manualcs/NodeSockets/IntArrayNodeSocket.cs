...
{
	/// <summary>
	/// IntArraySocket is used to communicate vectors between nodes.
	/// </summary>
	public class IntArrayNodeSocket : NodeSocketBase<List<int>>
	{
		/// <summary>
		...
		public IntArrayNodeSocket(Node parentNode, string name, string internalname, bool isInput)
