...
{
	/// <summary>
	/// BooleanArraySocket is used to communicate vectors between nodes.
	/// </summary>
	public class BooleanArrayNodeSocket : NodeSocketBase<List<bool>>
	{
		/// <summary>
		...
		public BooleanArrayNodeSocket(Node parentNode, string name, string internalname, bool isInput)
