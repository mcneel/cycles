...
{
	/// <summary>
	/// FloatNodeSocket is used to communicate a single float value between
	/// nodes.
	/// </summary>
	public class FloatNodeSocket : NodeSocketBase<float>
	{
		/// <summary>
		/// Create a new FloatNodeSocket.
		///
		...
		public FloatNodeSocket(Node parentNode, string name, string internalname, bool isInput) : base(parentNode, name, internalname, isInput)
		{
		}
