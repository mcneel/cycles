...
{
	/// <summary>
	/// ColorArraySocket is used to communicate vectors between nodes.
	/// </summary>
	public class ColorArraySocket : SocketBase<List<float3>>
	{
		/// <summary>
		...
		public ColorArraySocket(ShaderNode parentNode, string name, string internalname, bool isInput)
