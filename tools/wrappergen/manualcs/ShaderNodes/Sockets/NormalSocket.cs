...
{
	/// <summary>
	/// NormalSocket is used to communicate vectors between nodes.
	/// </summary>
	public class NormalSocket : SocketBase<float3>
	{
		/// <summary>
		...
		public NormalSocket(ShaderNode parentNode, string name, string internalname, bool isInput)
