...
CCL_CAPI ccl::Shader* CDECL cycles_create_shader(ccl::Session* session_id);
...
CCL_CAPI bool CDECL cycles_shader_get_name(ccl::Shader* shader, void* stringholder);
...
CCL_CAPI void CDECL cycles_shadernode_texmapping_set_transformation(ccl::ShaderNode* shnode, int transform_type, float x, float y, float z);
CCL_CAPI void CDECL cycles_shadernode_texmapping_set_mapping(ccl::ShaderNode* shnode, ccl::TextureMapping::Mapping x, ccl::TextureMapping::Mapping y, ccl::TextureMapping::Mapping z);
CCL_CAPI void CDECL cycles_shadernode_texmapping_set_projection(ccl::ShaderNode *shnode, ccl::TextureMapping::Projection tm_projection);
CCL_CAPI void CDECL cycles_shadernode_texmapping_set_type(ccl::ShaderNode *shnode, ccl::NodeMappingType tm_type);

CCL_CAPI void CDECL cycles_shadernode_set_member_bool(ccl::ShaderNode* shnode, const char* member_name, bool value);
CCL_CAPI void CDECL cycles_shadernode_set_member_float(ccl::ShaderNode* shnode_id, const char* member_name, float value);
CCL_CAPI void CDECL cycles_shadernode_set_member_int(ccl::ShaderNode* shnode, const char* member_name, int value);
CCL_CAPI void CDECL cycles_shadernode_set_member_vec(ccl::ShaderNode* shnode, const char* member_name, float x, float y, float z);
...
CCL_CAPI void CDECL cycles_shadernode_set_member_float_img(ccl::Session* session_id, unsigned int shader_id, unsigned int shnode_id, shadernode_type shn_type, const char* member_name, const char* img_name, float* img, unsigned int width, unsigned int height, unsigned int depth, unsigned int channels);
CCL_CAPI void CDECL cycles_shadernode_set_member_byte_img(ccl::Session* session_id, unsigned int shader_id, unsigned int shnode_id, shadernode_type shn_type, const char* member_name, const char* img_name, unsigned char* img, unsigned int width, unsigned int height, unsigned int depth, unsigned int channels);
...
CCL_CAPI void CDECL cycles_shader_set_heterogeneous_volume(ccl::Session* session_id, ccl::Shader *shader_id, unsigned int heterogeneous_volume);
