...
/* Light tree is on for HIP: without it the distribution sampler counts the skylight
 * in num_lights but never selects it, so lamps render 2x too bright. RH-98418. */
