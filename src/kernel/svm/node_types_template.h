...
SHADER_NODE_TYPE(RHINO_NODE_TEX_COORD)
SHADER_NODE_TYPE(RHINO_NODE_TEX_COORD_BUMP_DX)
SHADER_NODE_TYPE(RHINO_NODE_TEX_COORD_BUMP_DY)
SHADER_NODE_TYPE(RHINO_NODE_MATRIX_MATH)
SHADER_NODE_TYPE(RHINO_NODE_AZIMUTH_ALTITUDE_TRANSFORM)
SHADER_NODE_TYPE(RHINO_NODE_CHECKER_TEXTURE)
SHADER_NODE_TYPE(RHINO_NODE_NOISE_TEXTURE)
SHADER_NODE_TYPE(RHINO_NODE_WAVES_TEXTURE)
SHADER_NODE_TYPE(RHINO_NODE_WAVES_WIDTH_TEXTURE)
SHADER_NODE_TYPE(RHINO_NODE_PERTURBING_PART1_TEXTURE)
SHADER_NODE_TYPE(RHINO_NODE_PERTURBING_PART2_TEXTURE)
SHADER_NODE_TYPE(RHINO_NODE_GRADIENT_TEXTURE)
SHADER_NODE_TYPE(RHINO_NODE_BLEND_TEXTURE)
SHADER_NODE_TYPE(RHINO_NODE_EXPOSURE_TEXTURE)
SHADER_NODE_TYPE(RHINO_NODE_FBM_TEXTURE)
SHADER_NODE_TYPE(RHINO_NODE_GRID_TEXTURE)
SHADER_NODE_TYPE(RHINO_NODE_PROJECTION_CHANGER_TEXTURE)
SHADER_NODE_TYPE(RHINO_NODE_MASK_TEXTURE)
SHADER_NODE_TYPE(RHINO_NODE_PERLIN_MARBLE_TEXTURE)
SHADER_NODE_TYPE(RHINO_NODE_PHYSICAL_SKY_TEXTURE)
SHADER_NODE_TYPE(RHINO_NODE_TEXTURE_ADJUSTMENT_TEXTURE)
SHADER_NODE_TYPE(RHINO_NODE_TILE_TEXTURE)
SHADER_NODE_TYPE(RHINO_NODE_DOTS_TEXTURE)
SHADER_NODE_TYPE(RHINO_NODE_NORMAL_PART1_TEXTURE)
SHADER_NODE_TYPE(RHINO_NODE_NORMAL_PART2_TEXTURE)
