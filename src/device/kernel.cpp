...
#define FILM_CONVERT_KERNEL_AS_STRING(variant, variant_lowercase) \
  ...
  case DEVICE_KERNEL_FILM_CONVERT_##variant##_HALF_RGBA: \
    return "film_convert_" #variant_lowercase "_half_rgba";
      ...
      FILM_CONVERT_KERNEL_AS_STRING(SHADOW_CATCHER_TRANSPARENT_SAMPLE_COUNT, shadow_catcher_transparent_sample_count)
      FILM_CONVERT_KERNEL_AS_STRING(SHADOW_CATCHER_BACKGROUND_SAMPLE_COUNT, shadow_catcher_background_sample_count)
