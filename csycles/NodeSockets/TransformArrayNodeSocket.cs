...
{
	/// <summary>
	/// TransformArraySocket is used to communicate transforms between nodes.
	/// </summary>
	public class TransformArrayNodeSocket : NodeSocketBase<List<Transform>>
	{
		/// <summary>
		...
		public TransformArrayNodeSocket(Node parentNode, string name, string internalname, bool isInput)
