...
{
	/// <summary>
	/// PointArraySocket is used to communicate vectors between nodes.
	/// </summary>
	public class PointArrayNodeSocket : NodeSocketBase<List<float3>>
	{
		/// <summary>
		...
		public PointArrayNodeSocket(Node parentNode, string name, string internalname, bool isInput)
