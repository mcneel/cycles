...
{
	/// <summary>
	/// ColorSocket is used to communicate vectors between nodes.
	/// </summary>
	public class ColorNodeSocket : NodeSocketBase<float3>
	{
		/// <summary>
		...
		public ColorNodeSocket(Node parentNode, string name, string internalname, bool isInput)
