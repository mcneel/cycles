...
namespace ccl.NodeSockets
{
	...
	/// </summary>
	public class TransformNodeSocket : NodeSocketBase<Transform>
	{
		/// <summary>
		...
		public TransformNodeSocket(Node parentNode, string name, string internalname, bool isInput) : base(parentNode, name, internalname, isInput)
		{
		}
