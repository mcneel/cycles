...
{
	/// <summary>
	/// Point2ArraySocket is used to communicate vectors between nodes.
	/// </summary>
	public class Point2ArrayNodeSocket : NodeSocketBase<List<float2>>
	{
		/// <summary>
		...
		public Point2ArrayNodeSocket(Node parentNode, string name, string internalname, bool isInput)
