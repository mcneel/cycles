...
{
	/// <summary>
	/// VectorSocket is used to communicate vectors between nodes.
	/// </summary>
	public class VectorNodeSocket : NodeSocketBase<float3>
	{
		/// <summary>
		...
		public VectorNodeSocket(Node parentNode, string name, string internalname, bool isInput)
