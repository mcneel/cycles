...
{
	/// <summary>
	/// VectorArraySocket is used to communicate vectors between nodes.
	/// </summary>
	public class VectorArraySocket : SocketBase<List<float3>>
	{
		/// <summary>
		...
		public VectorArraySocket(ShaderNode parentNode, string name, string internalname, bool isInput)
