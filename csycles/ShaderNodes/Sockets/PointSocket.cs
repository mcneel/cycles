...
{
	/// <summary>
	/// PointSocket is used to communicate vectors between nodes.
	/// </summary>
	public class PointSocket : VectorSocket
	{
		/// <summary>
		...
		public PointSocket(ShaderNode parentNode, string name, string internalname, bool isInput)
