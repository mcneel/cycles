...
namespace ccl
{
	...
	/// </summary>
	public class NodeSocketCollection
	{
		readonly List<INodeSocket> m_socketlist = new List<INodeSocket>();

		/// <summary>
		/// Add socket so it can actually be linked to and from.
		/// </summary>
		/// <param name="sock"></param>
		internal void AddSocket(INodeSocket sock)
		{
		...
		/// <returns></returns>
		public INodeSocket Socket(string name)
		{
		...
		/// <returns></returns>
		public INodeSocket this[int idx]
		{
			get
			{
		...
		/// </summary>
		public IEnumerable<INodeSocket> Sockets => m_socketlist;
	}
}
